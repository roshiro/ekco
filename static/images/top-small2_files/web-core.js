...
W.Experiments.setDeploymentOrder([{id:"AppsList",description:"Temporary app store",dependencies:[],conflicts:[]},{id:"wixAppsActive",description:"",dependencies:[],conflicts:[]},{id:"Dev",description:"You are looking at it now!",dependencies:[],conflicts:[]},{id:"RefactorLinkUtils",description:"Refactor for LinkableComponent, LinkUtils and LinkDialog",dependencies:[],conflicts:[]},{id:"FBShare",description:"",dependencies:[],conflicts:[]},{id:"ZoomWidth",description:"BugFix: MediaZoomDisplay is now in min-width of 600px",dependencies:[],conflicts:[]},{id:"TPAPremium",description:"upgrading TPA",dependencies:[],conflicts:[]},{id:"SM",description:"Site Members (AKA Users of Users)",dependencies:[],conflicts:[]},{id:"Login",description:"",dependencies:["SM"],conflicts:[]},{id:"PageSecurity",description:"",dependencies:["SM"],conflicts:[]},{id:"HomepageSettings",description:"Set default homepage for your site",dependencies:["PageSecurity"],conflicts:[]},{id:"MasterPage",description:"New Master Page in editor",dependencies:[],conflicts:[]},{id:"MCM",description:"Refactor of ComponentEditBox",dependencies:["MasterPage"],conflicts:[]},{id:"GridLines",description:"Grid lines in editor",dependencies:["MCM","MasterPage"],conflicts:[]},{id:"SocialPanel",description:"MERGED!!",dependencies:[],conflicts:[]},{id:"URM",description:"Undo/Redo Manager - MERGED!!",dependencies:[],conflicts:[]},{id:"URMButtons",description:"URM Buttons in the top bar",dependencies:[],conflicts:[]},{id:"FPP",description:"Floating Property Panel",dependencies:[],conflicts:[]},{id:"FPPForcePanel",description:"Floating Property Panel with sticky Component Panel",dependencies:["FPP"],conflicts:[]},{id:"LazyShare",description:"",dependencies:[],conflicts:[]},{id:"Staff",description:"",dependencies:[],conflicts:[]},{id:"PaginatedGrid",description:"MERGED!!",dependencies:[],conflicts:[]},{id:"ToolTip",description:"MERGED!!",dependencies:[],conflicts:[]},{id:"PanelsData",description:"MERGED!!",dependencies:[],conflicts:[]},{id:"StyleNS",description:"MERGED!!",dependencies:[],conflicts:[]},{id:"Fullcolor",description:"MERGED!!",dependencies:[],conflicts:[]},{id:"IframeDialog",description:"MERGED!!",dependencies:[],conflicts:[]},{id:"Zoom",description:"MERGED!!",dependencies:[],conflicts:[]},{id:"WixApps",description:"Wix Apps (AKA Lists)",dependencies:[],conflicts:[]},{id:"NewComps",description:"",dependencies:[],conflicts:[]},{id:"Ecom",description:"eCommerce",dependencies:["NewComps","WixApps"],conflicts:[]},{id:"TPAVideo",description:"Shows video in TPA dialog",dependencies:["Ecom"],conflicts:[]},{id:"WalkMe",description:"WalkMe Button in the top bar",dependencies:[],conflicts:[]},{id:"PagesDropDown",description:"MERGED!!",dependencies:[],conflicts:[]},{id:"AudioPlayer",description:"",dependencies:[],conflicts:[]},{id:"SliderAutoPlay",description:"",dependencies:[],conflicts:[]},{id:"BoxShadow",description:"Control Shadows of Components in Advanced Styling",dependencies:["ColorPicker"],conflicts:[]},{id:"ColorPicker",description:"Refactor of the Color Picker",dependencies:[],conflicts:[]},{id:"Fix3713",description:"",dependencies:[],conflicts:[]},{id:"Photo",description:"MERGED!! - Photo using the NewImage component",dependencies:[],conflicts:[]},{id:"wixAppsActive",description:"",dependencies:[],conflicts:[]},{id:"Purple",description:'Purple "Upgrade" buttons',dependencies:[],conflicts:[]},{id:"FirstSave",description:"Wait 20 minutes before popping the Save Dialog ",dependencies:[],conflicts:[]},{id:"HourGlass",description:"Show an Hourglass on page transitions",dependencies:[],conflicts:[]},{id:"DoubleClick",description:"Add DoubleClick functionality to components",dependencies:["FPP"],conflicts:[]},{id:"PremiumWixAds",description:"Monetize WixAds in Preview Mode",dependencies:[],conflicts:[]},{id:"PartialSave",description:"Enable saving of partial data (separated pages, master page, and deleted pages)",dependencies:[],conflicts:[]},{id:"SaveBackup",description:"Saves every few seconds the partial-save request json so users can recover sites after a crash",dependencies:["PartialSave"],conflicts:[]},{id:"TraverseComps",description:"the component edit box traverses between components with ctrl+m, ctrl+shift+m",dependencies:["FPP"],conflicts:[]},{id:"GEM",description:"Gallery Expand Mode - adding an option that upon click on an image, it goes to the specified link",dependencies:["WixApps"],conflicts:[]},{id:"StyleRefactor",description:"New Style Objects",dependencies:[],conflicts:[]},{id:"Bug4356",description:"A temporary fix for bug 4356: Affects only Chrome and Safari. for more info: http://code.google.com/p/chromium/issues/detail?id=139613",dependencies:[],conflicts:[]},{id:"bug3313",description:"MERGED!!",dependencies:[],conflicts:[]},{id:"AppMarket",description:"TPA App Market UI",dependencies:[],conflicts:[]},{id:"SyncWixify",description:"Make wixify work sync - part of the base component refactor",dependencies:["StyleRefactor"],conflicts:[]},{id:"SaveMetaSiteDelta",description:"Empty dirty data after successful save and send metasite data only if it changed on save",dependencies:[],conflicts:[]},{id:"PhotoLayoutFix",description:"fixes the layout problem in public (height 100px)",dependencies:[],conflicts:[]},{id:"SlowCssGC",description:"run css garbage collection every 2 mn and not every 10 seconds)",dependencies:[],conflicts:[]},{id:"likefix",description:"fixes the address that the facebook like button use. in editor it uses wix.com and on public main page is just the base url",dependencies:[],conflicts:[]},{id:"PSMenuFix",description:"fixes sites with old horizontal menu when partial save is on",dependencies:[],conflicts:[]},{id:"SaveFreeze",description:"prevent users from editing while save is in progress",dependencies:[],conflicts:[]}]);
...
}var a=function(j){switch(j){case"app-state":return this._getCurrentState();
break;
...
break;
case"locale":return window.wixEditorLangauge;
break;
case"viewMode":var i=this.injects().Viewer.getViewMode()||"unknown";
return i;
break;
...
}else{if((!this._isPageAutoShrink()||b.toComp.getOriginalClassName()!="mobile.core.components.Page")){c+=this.DEFAULT_MARGIN
...
}else{if(!b.locked&&(!this._isPageAutoShrink()||e.getOriginalClassName()!="mobile.core.components.Page")){c=b.originalValue
...
if(!e.locked&&(!this._isPageAutoShrink()||a.getOriginalClassName()!="mobile.core.components.Page")){f=Math.max(f,e.originalValue)
}c=Math.max(f,c)
}.bind(this));
return c
...
},_getRenderModifiers:function(){return W.Viewer._siteStructureData.get("renderModifiers")||{}
...
this._pages=c
},_fixPagesOrderByNewMenuData:function(a){return a
