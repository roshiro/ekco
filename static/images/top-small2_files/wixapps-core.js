...
W.Classes.newClass({name:"wixapps.core.events.ProxyEventBus",imports:["wixapps.core.events.TreePath"],Class:{Extends:Events,_map:null,_originals:[],_interceptors:[],initialize:function(){this._map={parent:Constants.WixAppTreeRelation.PARENT,ancestor:Constants.WixAppTreeRelation.ANCESTOR,sibling:Constants.WixAppTreeRelation.SIBLING,descendant:Constants.WixAppTreeRelation.DESCENDANT,"parent-descendant":Constants.WixAppTreeRelation.PARENT_DESCENDANT,"sibling-descendant":Constants.WixAppTreeRelation.SIBLING_DESCENDANT}
},addEventFilteredByScope:function(b,e,d,c,a){var f=this._map[e];
if(!f){throw'"'+e+'" is invalid scope value'
}var g=function(h){var j=h&&h.context&&h.context.getEnvironment().getTreePath();
var i=b.getEnvironment().getTreePath();
if(i&&j&&i.isOtherRelatedToThisAs(j,f)){c(h)
}};
...
Constants.WixAppTreeRelation=Constants.WixAppTreeRelation||{PARENT:1,ANCESTOR:2,SIBLING:4,DESCENDANT:8,PARENT_DESCENDANT:16,SIBLING_DESCENDANT:32};
(function(){var a=0;
W.Classes.newClass({name:"wixapps.core.events.TreePath",Class:{_path:null,initialize:function(b){this._path=b?b._path.clone():[];
this._path.push(a++)
},isOtherRelatedToThisAs:function(b,c){switch(c){case Constants.WixAppTreeRelation.PARENT:return !this.isRoot()&&b.get(-1)==this.get(-2);
case Constants.WixAppTreeRelation.ANCESTOR:return this._path.indexOf(b.get(-1))!=-1;
case Constants.WixAppTreeRelation.SIBLING:return !this.isRoot()&&(this._path.length==b._path.length)&&this.get(-2)==b.get(-2);
...
W.Classes.newClass({name:"wixapps.core.utils.WixAppsLogger",imports:[],Class:{Static:{LISTS_EVENT_SOURCE:60,Type:{ERROR:10,USER_ACTION:40},Category:{EDITOR:1,VIEWER:2,CORE:3,SERVER:4},SubCategory:{GENERAL:0,PROXY:1,APP_LOGIC:2,DATA_SERVICE:3,DATA_ITEMS:4,CORE_WIRING:5},Severity:{RECOVERABLE:10,WARNING:20,ERROR:30,FATAL:40},Errors:{GENERIC_ERROR:{code:-20000,description:"WixApps unspecified error"},APP_INSTANCE_NOT_LOADED:{code:-20001,description:"Application instance failed to load"}},Events:{}},reportError:function(c,f,a,i,b,g){try{var d={desc:c.description||this.Errors.GENERIC_ERROR.description,errorCode:c.code||this.Errors.GENERIC_ERROR.code,type:this.Type.ERROR,issue:i||this.SubCategory.GENERAL,severity:b||this.Severity.ERROR,category:g||this.getDefaultCategory()};
...
W.Classes.newClass({name:"wixapps.core.views.ProxyFactory",imports:["wixapps.core.events.ProxyEventBus","wixapps.core.views.ViewEnvironment","wixapps.core.views.ViewContext"],Class:{Binds:[],_viewRepository:null,_dataItemFactory:null,_typesManager:null,_managers:null,_defaultByTypeAndMode:{},_byName:{},_eventDispatcher:null,_contextPath:null,initialize:function(c,d,f,b,e,a){this._viewRepository=f;
...
var a=new this.imports.ViewEnvironment(this._dataItemFactory,this._typesManager,this,e,c.getTypeName(),d,this._eventDispatcher,[]);
...
},evaluatePath:function(f){if(f.indexOf("var:")==0){var c=this._environment;
var e=c.getVar(f.substr(4));
if(e===undefined||e===null){return undefined
}var b=c.getDataItemFactory().createDataItem(e);
return new this.constructor(c,b,this)
}else{var d=f.split(".");
var a=this;
d.forEach(function(i){if(i=="parent"){a=a.getParentWithCascadedEnvironment()
}else{if(i=="this"){}else{var g=i.match(/^(.*)\[([0-9]+)\]$/);
if(g){var j=g[1];
var h=g[2];
a=a.getChildByRef(j).getChildByIndex(h)
}else{a=a.getChildByRef(i)
}}}});
...
W.Classes.newClass({name:"wixapps.core.views.ViewEnvironment",imports:["wixapps.core.events.TreePath"],Class:{Binds:[],_dataItemFactory:null,_typesManager:null,_proxyFactory:null,_viewName:null,_forType:null,_mode:null,_fieldId:null,_eventsDispatcher:null,_includedViews:null,_treePath:null,_vars:null,initialize:function(h,k,b,j,d,e,a,c,g,f,i){this._dataItemFactory=h;
...
this._vars=g?Object.clone(g):{};
this._fieldId=f;
this._treePath=new this.imports.TreePath(i)
},newCopy:function(){return new this.constructor(this._dataItemFactory,this._typesManager,this._proxyFactory,this._viewName,this._forType,this._mode,this._eventsDispatcher,this._includedViews,this._vars,this._fieldId,this._treePath)
...
}},getVar:function(a){return this._vars[a]
},setVar:function(a,b){this._vars[a]=b
},deleteVar:function(a){delete this._vars[a]
}}});
...
},setupProxy:function(){},createComponent:function(){},_registerProxyEvents:function(b,a){},_onDefinitionsChanged:function(a){},_onDefinitionsChangedInternal:function(a){this._onDefinitionsChanged(a)
},_onDataChanged:function(a){},_onDataChangedInternal:function(a){this._onDataChanged(a)
},getViewContext:function(){return this._viewContext
