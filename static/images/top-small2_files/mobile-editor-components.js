...
Constants.DialogWindow={CLICK_OUTSIDE:"ClickOutside",POSITIONS:{DYNAMIC:"dynamic",CENTER:"center",TOP:"top",SIDE:"side",ORIGIN:{x:92,y:65},OFFSET:{x:20,y:20}},TYPES:{MODAL:"modal",SEMI_MODAL:"semiModal",NON_MODAL:"nonModal",TRANSPARENT_MODAL:"transparentModal"},DEFAULT:{WIDTH:480,MIN_HEIGHT:150,MAX_HEIGHT:650,TOP:10,HEIGHT_OFFSET:70,BOUNDARY_OFFSET:20}};
W.Components.newComponent({name:"mobile.editor.components.dialogs.DialogWindow",skinParts:{blockLayer:{type:"htmlElement"},innerDialog:{type:"htmlElement"},dialogBox:{type:"htmlElement"},dialogToolbar:{type:"htmlElement"},dialogTitle:{type:"htmlElement"},dialogSubTitle:{type:"htmlElement",optional:true},dialogIcon:{type:"htmlElement",optional:true},helplet:{type:"htmlElement"},dialogDescription:{type:"htmlElement"},buttonContainer:{type:"htmlElement"},tabs:{type:"htmlElement"},okContainer:{type:"htmlElement"},cancelContainer:{type:"htmlElement"},xButton:{type:"htmlElement"},dragArea:{type:"htmlElement"}},Class:{Extends:"mobile.core.components.base.BaseComponent",_states:{windowType:[Constants.DialogWindow.TYPES.MODAL,Constants.DialogWindow.TYPES.SEMI_MODAL,Constants.DialogWindow.TYPES.NON_MODAL,Constants.DialogWindow.TYPES.TRANSPARENT_MODAL],helpLocation:["normalHelpLocation","topHelpLocation"]},_renderTriggers:[Constants.DisplayEvents.ADDED_TO_DOM,Constants.DisplayEvents.DISPLAYED,Constants.DisplayEvents.DISPLAY_CHANGED],Binds:["closeDialog","_innerDialogReady","_onButtonReady","_closeOnOutsideClick","_blockMouseEventsOnDialog","_unBlockMouseEventsOnDialog","_setDialogHeightRelativeToWindowHeight","_tabChanged"],Static:{DRAG_OFFSET:40},initialize:function(c,b,a){this.parent(c,b,a);
...
this._setOptions(a);
this._modalMode=(a.nonModal&&Constants.DialogWindow.TYPES.NON_MODAL)||(a.semiModal&&Constants.DialogWindow.TYPES.SEMI_MODAL)||(a.transparentModal&&Constants.DialogWindow.TYPES.TRANSPARENT_MODAL)||Constants.DialogWindow.TYPES.MODAL;
