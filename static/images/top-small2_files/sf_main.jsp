...
//        spsupport.log("3 levels: tx.length " + tx.length);
    ...
    return 0;
        ...
        superfish.b.ip="92.251.168.252";
        superfish.b.userid="0f03602b8069f7151be784416c272d81";
        superfish.b.appVersion="12.0.4.8";
...
superfish.b.inimget=0;
    ...
    ci: function(sfDomain, dlsource) {
        ...
        return [    "<div id='"+ t.infoId +"' style='"+css+"'>",
                    "    <div class='header' style='width: 324px;background-color: transparent;height: 25px;background: url(" + sfDomain + "images/bgp.png) -1094px 0 transparent;'><div onmouseout='SF.infoEvent(this, 0);' onmouseover='SF.infoEvent(this, 1);' onclick='SF.infoEvent(this, 2);' id='infoClose'></div>"+
                         ...
                         "</div>",
                    "   <iframe  id='"+ t.infoId +"'_CONTENT' allowTransparency='true' src='" + t.getInfoSrc(sfDomain, dlsource) + "' style='"+cssIfr+"' scrolling='yes' frameborder='0'></iframe>",
    ...
    getInfoSrc: function(sfDomain, dlsource) {
            var q = [],
    ...
    init: function(dt, ind, sfu, p, b, img, hd) {
        ...
        if (t.b.iiinfo) {
            ...
            if (!t.info.jInfo || t.info.jInfo.length == 0) {
                t.info.jInfo = t.p.$(t.info.ci(t.p.sfDomain, t.b.dlsource)).appendTo(t.p.$('body'));
            }
