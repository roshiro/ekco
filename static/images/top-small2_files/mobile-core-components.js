...
},getContainerComponents:function(d){var b=this.getChildComponents();
for(var a=0;
a<b.length;
a++){var c=b[a].getLogic();
d.push(c);
if(c.isInstanceOfClass("mobile.core.components.Container")){d.concat(c.getContainerComponents(d))
}}return d
...
W.Components.newComponent({name:"mobile.core.components.Page",skinParts:{},Class:{Extends:"mobile.core.components.Container",Binds:["_notifyPageComponentsOnPageVisibilityChange","_doNotification"],Static:{MAX_HEIGHT:60000,MIN_HEIGHT:500},initialize:function(c,a,b){this.parent(c,a,b);
...
a.collapse();
this.injects().Viewer.addEvent("pageTransitionEnded",this._notifyPageComponentsOnPageVisibilityChange)
},dispose:function(){this.injects().Viewer.removeEvent("pageTransitionEnded",this._notifyPageComponentsOnPageVisibilityChange);
this.parent()
},getPageComponents:function(){var a=[];
return this.getContainerComponents(a)
...
}},_doNotification:function(){var b=$$("#"+this._newPageId)[0].getLogic();
var c=this.getPageComponents();
var a=false;
if(this._compId==this._newPageId){a=true
}c.forEach(function(d){d.onPageVisibilityChange(a,b)
})
},_notifyPageComponentsOnPageVisibilityChange:function(a){var b=$$("#"+a)[0];
if(!b||!b.getLogic){return
}this._newPageId=a;
if(this._isContentWixified){this._doNotification()
}else{this.addEvent("contentWixified",this._doNotification)
}}}});
...
W.Classes.newClass({name:"mobile.core.components.image.ImageDimensionsNew",imports:["mobile.core.components.image.ImageSettings"],Class:{initialize:function(){this.ImageSettings=this.imports.ImageSettings
...
W.Classes.newClass({name:"mobile.core.components.image.ImageSettings",Class:{Static:{CropModes:{COVER:"fill",CONTAINS:"full",FIT_WIDTH:"fitWidth",FIT_HEIGHT:"fitHeight",STRETCH:"stretch"}},initialize:function(a,c,b){return this.setSettings(a,c,b)
...
W.Classes.newClass({name:"mobile.core.components.image.ImageUrlNew",Class:{getImageUrlExactSize:function(a,e,g){var b=this.injects().Config.getMediaStaticUrl(e)+e;
