...
}},_onSaveSuccess:function(){var b=this._lastSaveParam;
...
}}try{if(window.opener&&window.opener.document.domain==document.domain){window.opener.location.reload()
}}catch(a){}},_onSaveFail:function(a,b){var c=this._lastSaveParam;
W.Editor.getEditorStatusAPI().setSaveInProcess(false);
if(c&&c.onErrorCallback){c.onErrorCallback()
}else{if(c&&c.promptResultDialog){W.EditorDialogs.openPromptDialog(W.Resources.get("EDITOR_LANGUAGE","ERROR_SAVE_TITLE"),W.Resources.get("EDITOR_LANGUAGE","ERROR_SAVE_DOCUMENT"),W.Resources.get("EDITOR_LANGUAGE","ERROR_CODE_IS")+" "+b,W.EditorDialogs.DialogButtonSet.OK)
...
W.EditorDialogs.openPromptDialog(W.Resources.get("EDITOR_LANGUAGE","ERROR_PUBLISH_TITLE"),W.Resources.get("EDITOR_LANGUAGE","ERROR_PUBLISH_DESC")+" ("+c+")","",W.EditorDialogs.DialogButtonSet.OK,function(){})
}.bind(this))
}}.bind(this);
