...
W.Data.registerDataTypeSchema("Document",{renderModifiers:"object",name:"string",mainPage:"ref",mainPageId:"string",pages:"refList"});
...
},isReady:function(){if(this._isReady){return true
}var a=this.getWaitingForReadyList();
if(a.length>0){this._isReady=false
}else{this._isReady=true
}return this._isReady
},getWaitingForReadyList:function(){var g=[];
var e=this.getAllItems();
var a=this.getDataManager();
for(var c=0;
c<e.length;
c++){var d=e[c];
var f=d.get("refId");
var b=W.Data.isDataAvailable(f);
if(!b){g.push(f)
}}return g
}}});
